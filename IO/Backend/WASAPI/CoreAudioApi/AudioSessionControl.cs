...
namespace GotaSoundIO.IO.Backend.WASAPI.CoreAudioApi
{
    ...
    public class AudioSessionControl : IDisposable
    {
        ...
        public void Dispose()
        {
            ...
            {
                Marshal.ThrowExceptionForHR(audioSessionControlInterface.UnregisterAudioSessionNotification((Interfaces.IAudioSessionEvents)audioSessionEventCallback));
        ...
        public void RegisterEventClient(IAudioSessionEventsHandler eventClient)
        {
            ...
            Marshal.ThrowExceptionForHR(audioSessionControlInterface.RegisterAudioSessionNotification((Interfaces.IAudioSessionEvents)audioSessionEventCallback));
        }
