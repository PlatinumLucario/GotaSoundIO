...
namespace GotaSoundIO.IO.Backend.WinMM
{
    // Note: All code in here has been copied from NAudio.WinMM, some of which has been modified from the original code to allow compatibility with Microsoft.NETCore.App framework.
